            ...
            <View style={styles.container}>
                ...
                <View style={styles.headingContainer}>
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                        <Text style={styles.titleText1}>Look M</Text><Text style={styles.titleText2}>e App</Text>
                    </View>
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                        <Text style={styles.subheading1}>Try Our You</Text><Text style={styles.subheading2}>r New Looks</Text>
                    </View>
                </View>
